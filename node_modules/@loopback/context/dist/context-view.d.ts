 ...
 * @param session Resolution session
 */
export declare function createViewGetter<T = unknown>(ctx: Context, bindingFilter: BindingFilter<T>, session?: ResolutionSession): Getter<T[]>;
